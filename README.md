...
Add dependencies: Spring Web, Spring Data JPA, H2 or MySQL.
Configure application.properties for the datasource and Hibernate DDL.
Create the Student entity and annotate with @Entity.
Create StudentRepository by extending JpaRepository.
Implement StudentController to expose REST endpoints.
Run and test the endpoints (Postman / curl / browser).
...
<img width="954" height="620" alt="image" src="https://github.com/user-attachments/assets/8530ddf0-6402-420f-95ec-10637ea0706f" />
GET /students — list all students
<img width="952" height="627" alt="image" src="https://github.com/user-attachments/assets/5e887551-977b-4600-93ed-19359df3945f" />
PUT /students/{id} — update student
<img width="952" height="620" alt="image" src="https://github.com/user-attachments/assets/3ecc9bf0-af2e-4b19-822a-9e6d6c03b810" />
DELETE /students/{id} — delete student
<img width="954" height="627" alt="image" src="https://github.com/user-attachments/assets/ed287aa2-4b8f-454f-9a16-ab66ea9be96e" />
